        ...
        <div className="grid grid-cols-12 gap-6 max-sm:gap-5">
          {currentItems?.map((items, index) => {
            return (
              <div
                key={index}
                className="bg-[#092C39] relative rounded-[8px] 2xl:col-span-2 lg:col-span-3 md:col-span-4 col-span-6 p-2 max-sm:p-0"
              >
                ...
                >
                  <svg
                    className="w-5 h-5 text-gray-800 dark:text-green"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
