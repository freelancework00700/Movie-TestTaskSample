...
export default function MoviesList() {
    ...
    useEffect(() => {
        const getMovies = async () => {
            if (allMovies.length > 0) {
                ...
                console.log('16-----response?.data', response?.data?.movies)
    ...
    console.log('curerntItems :>> ', currentItems);
    return (
        <>
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    ...
                                                    <AlertDialogFooter>
                                                        ...
                                                        <AlertDialogAction>
                                                            <button
                                                                // className="flex justify-center items-center h-[30px] w-[30px] bg-[#00000070] rounded-[30px]"
